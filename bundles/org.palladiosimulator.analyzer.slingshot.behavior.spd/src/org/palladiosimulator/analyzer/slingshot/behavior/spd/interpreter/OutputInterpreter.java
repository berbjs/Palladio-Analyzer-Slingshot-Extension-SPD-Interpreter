...
final class OutputInterpreter extends StimuliSwitch<InterpretationResult> {
	...
	public OutputInterpreter(final ScalingTriggerInterpreter scalingTriggerInterpreter, final SimpleFireOnOutput trigger) {
		super();
	...
	public InterpretationResult caseSimulationTime(final SimulationTime object) {
		...
		final RepeatedSimulationTimeReached event = new RepeatedSimulationTimeReached(this.scalingTriggerInterpreter.policy.getTargetGroup().getId(), expectedTime.getValue());
		...
		return (new InterpretationResult()).scheduleEvent(event)
										   ...
										   .triggerChecker(new OutputInterpreterWrapper<SimulationTime>(new SimulationTimeChecker(this.trigger)));
	}
	...
	public InterpretationResult caseOperationResponseTime(final OperationResponseTime object) {
		...
		return (new InterpretationResult()).listenEvent(Subscriber.builder(MeasurementMade.class)
									       ...
									       .triggerChecker(new OutputInterpreterWrapper<OperationResponseTime>(new OperationResponseTimeTriggerChecker(this.trigger)));
	}
	...
	public InterpretationResult caseCPUUtilization(final CPUUtilization object) {
		...
		return (new InterpretationResult()).listenEvent(Subscriber.builder(MeasurementMade.class)
										   ...
										   .triggerChecker(new OutputInterpreterWrapper<CPUUtilization>(
												   				   new CPUUtilizationTriggerChecker(
													   				   this.trigger, 
																	   object, 
	...
	public InterpretationResult caseTaskCount(final TaskCount object) {
		...
		return (new InterpretationResult()).listenEvent(Subscriber.builder(MeasurementMade.class)
																  .name("taskCount"))
										   .triggerChecker(new OutputInterpreterWrapper<TaskCount>(new TaskCountTriggerChecker(this.trigger, object, this.scalingTriggerInterpreter.policy.getTargetGroup())));
	}
	...
	public InterpretationResult caseQueueLength(final QueueLength object) {
		...
		return (new InterpretationResult()).listenEvent(Subscriber.builder(MeasurementMade.class).name("queueLength"))
				.triggerChecker(new OutputInterpreterWrapper<QueueLength>(new QueueLengthTriggerChecker(this.trigger, object)));
	}
