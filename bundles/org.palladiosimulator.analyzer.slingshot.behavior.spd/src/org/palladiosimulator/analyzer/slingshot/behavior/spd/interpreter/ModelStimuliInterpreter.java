...
final class ModelStimuliInterpreter extends StimuliSwitch<InterpretationResult> {

	private final ScalingTriggerInterpreter scalingTriggerInterpreter;
	private final SimpleFireOnValue trigger;

	public ModelStimuliInterpreter(final ScalingTriggerInterpreter scalingTriggerInterpreter, final SimpleFireOnValue trigger) {
		super();
